"""
Configuration 3b: L2 Cache Scaling - 512kB L2, n=100,000
Doubles the L2 from 256kB -> 512kB to accommodate the 400kB footprint
of 100k integers. Should significantly reduce L2 misses and DRAM traffic.
"""
import os
import sys
...
# Doubled L2 to 512kB to accommodate the 400kB working set
...
print("=== CONFIG 3b: O3CPU + 512kB L2 (mitigated) + n=100,000 ===")
simulator.run()
print("Config 3b simulation complete!")
